...
func ReadOnly(method, path string) bool {
	...
	for _, prefix := range []string{"/api/v1/u/user/basic_profile/", "/api/v1/lms/user/user-courses/", "/api/v1/lms/learn/leaf_info/", "/api/v1/lms/learn/course/", "/api/v1/lms/exercise/get_exercise_list/", "/api/v1/lms/service/playurl/", "/video-log/get_video_watch_progress/"} {
