...
import { mountAdminSettings } from '../admin/settings.js';
...
export function mountWorkspace(host, user, logout) {
  ...
  life.add(startRouter(route => {
    ...
    if (admin) {
      ...
      else if (route.path === '/admin/settings') disposePage = mountAdminSettings(main);
