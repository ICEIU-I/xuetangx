...
<style scoped>
.auth-layout{max-width:1120px;margin:9vh auto;display:grid;grid-template-columns:1.1fr 1fr;gap:64px;padding:24px;align-items:center}.auth-eyebrow{color:var(--text-accent);letter-spacing:3px;font-size:13px}.auth-intro h1{font-size:clamp(32px,4vw,52px);line-height:1.35;margin:24px 0}.auth-intro p{max-width:430px;line-height:1.9;color:var(--text-dim)}.auth-points{display:flex;gap:22px;margin-top:34px;font-size:13px;color:var(--text-accent)}.auth-card{padding:32px}.auth-card h2{font-size:26px}.auth-card label{display:block;margin:20px 0 8px}.auth-card input{display:block;box-sizing:border-box;width:100%;margin-top:8px;padding:12px;background:var(--input-bg);border:1px solid var(--border-bright);border-radius:7px;color:var(--text);caret-color:var(--text);font-size:15px}.auth-card form>button{width:100%;margin:24px 0 8px;padding:12px}.auth-card form>button{background:var(--action-bg);color:var(--action-text);border-color:var(--action-bg);font-size:14px}.auth-card input:-webkit-autofill{-webkit-text-fill-color:var(--text);box-shadow:0 0 0 1000px var(--input-bg) inset}.auth-links{display:flex;gap:10px;flex-wrap:wrap;margin-top:18px}.auth-links button{font-size:12px;padding:5px}.error{color:var(--text-error)}.notice{color:var(--text-success)}@media(max-width:720px){.auth-layout{grid-template-columns:1fr;gap:26px;margin:2vh auto}.auth-intro h1{font-size:30px}.auth-points{display:none}.auth-card{padding:22px}}
</style>
